...
// kcal = 완전한 한 끼 기준 (밥 1공기 약 300kcal + 국·반찬 포함)
export const MEAL_LIB = {
  '두부조림 백반':    { kcal: 580, ing: ['두부 2모', '간장 3T', '대파 1대', '마늘 5쪽'], baby: false },
  '닭가슴살 샐러드':  { kcal: 480, ing: ['닭가슴살 200g', '양상추 1/2통', '방울토마토 10개', '올리브오일 2T'], baby: false },
  '소고기 미역국':    { kcal: 720, ing: ['소고기 200g', '미역 30g', '국간장 2T', '참기름 1T'], baby: true, babyNote: '미역 부드럽게 다지기, 간 X' },
  '제육볶음':        { kcal: 810, ing: ['돼지고기 300g', '고추장 3T', '양파 1개', '대파 1대'], baby: false },
  '연어구이 정식':    { kcal: 650, ing: ['연어 200g', '레몬 1/2개', '아스파라거스 6대', '버터 20g'], baby: true, babyNote: '연어 30g 으깨서 죽에' },
  '김치찌개':        { kcal: 700, ing: ['묵은지 200g', '돼지고기 150g', '두부 1모', '대파 1대'], baby: false },
  '계란 토마토 볶음':  { kcal: 630, ing: ['달걀 3개', '토마토 2개', '대파 1대'], baby: true, babyNote: '노른자만, 토마토 으깨서' },
  '시금치 된장국':    { kcal: 590, ing: ['시금치 1단', '된장 2T', '바지락 200g'], baby: true, babyNote: '시금치 잎만, 바지락 X' },
  '버섯 리조또':      { kcal: 530, ing: ['표고 5개', '쌀 1.5컵', '파마산 30g', '버터 15g'], baby: false },
  '오이냉국':        { kcal: 520, ing: ['오이 2개', '식초 2T', '국간장 1T'], baby: false },
  '고등어구이':       { kcal: 690, ing: ['고등어 1마리', '소금 약간', '레몬 1/2개'], baby: false },
  '잡채':           { kcal: 710, ing: ['당면 200g', '소고기 150g', '시금치 1단', '당근 1개'], baby: false },
  '그릭 요거트 볼':   { kcal: 320, ing: ['그릭요거트 200g', '블루베리 50g', '꿀 1T', '그래놀라 30g'], baby: false },
  '닭곰탕':         { kcal: 650, ing: ['닭 1/2마리', '대파 2대', '마늘 통째', '소금'], baby: true, babyNote: '닭 살코기 잘게 찢어 죽에' },
  '비빔밥':         { kcal: 650, ing: ['시금치', '콩나물', '소고기 100g', '계란 1개', '고추장 2T'], baby: false },
  '두부면 파스타':    { kcal: 420, ing: ['두부면 200g', '방울토마토 10개', '바질', '올리브오일 2T'], baby: false },
  '갈비찜':         { kcal: 890, ing: ['소갈비 500g', '무 1/4개', '당근 1개', '간장 4T'], baby: true, babyNote: '갈빗살 30g 잘게 찢어' },
  '단호박 수프':      { kcal: 430, ing: ['단호박 1/2개', '우유 200ml', '버터 10g'], baby: true, babyNote: '단호박 으깨서 그대로' },
  '오트밀 죽':       { kcal: 350, ing: ['오트밀 60g', '우유 200ml', '바나나 1개'], baby: false },
  '아보카도 토스트':  { kcal: 450, ing: ['식빵 2장', '아보카도 1개', '계란 2개'], baby: false },
};
